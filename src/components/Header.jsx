  ...
  return (
    <>
      <header style={{
        ...
        background: scrolled || menuOpen ? 'rgba(10,10,8,.95)' : 'transparent',
        ...
        {!isMobile && (
          <nav style={{ display: 'flex', gap: '36px', alignItems: 'center' }}>
            ...
            <div style={{ width: '1px', height: '18px', background: 'rgba(201,169,110,.2)' }} />
            <a href="https://github.com/bouyesaturnin" target="_blank" rel="noopener noreferrer"
              style={{ display: 'flex', color: '#6b6657', textDecoration: 'none', transition: 'color .25s' }}
              onMouseEnter={e => e.currentTarget.style.color = '#c9a96e'}
              onMouseLeave={e => e.currentTarget.style.color = '#6b6657'}
            >
        ...
        {isMobile && (
          <button onClick={() => setMenuOpen(o => !o)} style={{
            ...
            {[0, 1, 2].map(i => (
              <span key={i} style={{
                display: 'block', width: '24px', height: '1.5px', background: '#c9a96e',
          ...
          {links.map(link => (
            <a key={link}
              ...
              style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '2.2rem',
                fontWeight: 300, color: '#f0ead8', textDecoration: 'none',
                letterSpacing: '.08em', transition: 'color .25s' }}
              onMouseEnter={e => e.target.style.color = '#c9a96e'}
              onMouseLeave={e => e.target.style.color = '#f0ead8'}
            >{link}</a>
          ))}
          <div style={{ display: 'flex', gap: '24px', marginTop: '16px' }}>
            <a href="https://github.com/bouyesaturnin" target="_blank" rel="noopener noreferrer"
              style={{ color: '#6b6657', textDecoration: 'none' }}>
